...
path_model_weights_load = 'D:/boyLen/Python/Pylearn1/TensorFlowFu/TensorTeacher/data/fiv/005_Conv2DAE_v1.2_20'
...
class Conv2DAe(keras.Model, ABC):
    def __init__(self):
        ...
        self.sq1 = Sequential([
            ...
            layers.Conv2D(filters=32, kernel_size=[8, 8], activation='relu', padding='same', strides=4), layers.MaxPool2D(),
            layers.BatchNormalization(),
