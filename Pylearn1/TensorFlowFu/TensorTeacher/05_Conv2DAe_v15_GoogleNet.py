...
read_num = 100000
to_be_one = 10000.
path_model_weights_save = 'D:/boyLen/Python/Pylearn1/TensorFlowFu/TensorTeacher/data/005_Conv2DAE_v1.5'
path_model_weights_load = 'D:/boyLen/Python/Pylearn1/TensorFlowFu/TensorTeacher/data/005_Conv2DAE_v1.5_final'
...
def train(train_time=100):
    ...
    for epoch1 in range(train_time):
        ...
        if epoch1 % 5 == 0: model1.save_weights(path_model_weights_save + '_{0}'.format(epoch1))
