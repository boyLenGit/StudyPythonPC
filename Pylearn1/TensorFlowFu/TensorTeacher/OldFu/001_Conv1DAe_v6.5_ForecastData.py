...
path_model_weights = 'D:/boyLen/Python/Pylearn1/TensorFlowFu/TensorTeacher/data/001_Conv1DAE_v6.3_final'
...
def boylen_train(db_all):
    ...
    # 多进程同步保存Segy文件
    LenSegy.len_save_segy_multi_process(list_result_all_fusion, path_segy_file, 'F:/test_result_v2.segy')
